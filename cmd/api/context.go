...
// User struct added to the context. Note that we use the userContextKey constant as the key
...
// As we discussed earlier in the book, it is OK to panic in those circumstances.
