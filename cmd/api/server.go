...
func (app *application) server() error {
	...
	go func() {
		...
		//PS: making sure all background tasks have done executing:
	...
	app.logger.PrintInfo(fmt.Sprintf("starting the server on http://localhost%s", srv.Addr), map[string]string{
		"add": srv.Addr,
		"env": app.config.env,
	})
